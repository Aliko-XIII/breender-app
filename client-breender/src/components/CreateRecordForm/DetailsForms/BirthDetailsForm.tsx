...
export const BirthDetailsForm: React.FC<DetailFormProps<BirthDetailsDto>> = ({ onChange, onValidityChange }) => {
    const [details, setDetails] = useState<BirthDetailsDto>({ offspringCount: 0, liveOffspringCount: undefined, complications: '', notes: '' });
