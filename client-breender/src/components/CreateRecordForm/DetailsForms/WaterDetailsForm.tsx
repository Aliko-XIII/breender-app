...
export const WaterDetailsForm: React.FC<DetailFormProps<WaterDetailsDto>> = ({ onChange, onValidityChange }) => {
    const [details, setDetails] = useState<WaterDetailsDto>({ amountConsumed: 0, unit: '', notes: '' });
