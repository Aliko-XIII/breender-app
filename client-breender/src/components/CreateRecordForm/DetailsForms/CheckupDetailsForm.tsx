...
export const CheckupDetailsForm: React.FC<DetailFormProps<CheckupDetailsDto>> = ({ onChange, onValidityChange }) => {
    const [details, setDetails] = useState<CheckupDetailsDto>({ notes: '', vetName: '' });
